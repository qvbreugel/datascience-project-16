...
INSERT INTO Employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) VALUES (1088,'Patterson','William','x4871','wpatterson@classicmodelcars.com',6,1056,'Sales Manager (JAPAN, APAC)');
INSERT INTO Employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) VALUES (1102,'Bondur','Gerard','x5408','athompson@classicmodelcars.com',4,1056,'Sale Manager (EMEA)');
INSERT INTO Employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) VALUES (1143,'Bow','Anthony','x5428','bhoward@classicmodelcars.com',1,1056,'Sales Manager (NA)');
...
INSERT INTO Employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) VALUES (1216,'Patterson','Steve','x4334','spatterso@classicmodelcars.com',2,1143,'Sales Rep');
...
INSERT INTO Employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) VALUES (1621,'Nishi','Mami','x101','mnishi@classicmodelcars.com',5,1088,'Sales Rep');
INSERT INTO Employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) VALUES (1625,'Kato','Yoshimi','x102','ekato@classicmodelcars.com',5,1088,'Sales Rep');
INSERT INTO Employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) VALUES (1702,'Gerard','Martin','x2312','gmartin@classicmodelcars.com',4,1102,'Sales Rep');
